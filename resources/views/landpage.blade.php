...
<body>
    ...
    <nav class="flex justify-between items-center p-4 fixed top-0 left-0 right-0 border-b-1 border-black bg-[rgba(20,20,20,0.8)] text-white z-50">
        ...
        <div class="inline-block space-x-4 mx-4 my-0 text-base font-sans">
            ...
            <a href="#pesan" class="nav-link link-underline" data-target="pesan">Pesan</a>
        </div>
    </nav>
    ...
    <section id="menu" class="bg-white py-16">
        <div data-aos="fade-up" data-aos-delay="200" data-aos-duration="800" class="max-w-7xl mx-auto px-4 text-center pt-12">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                <!-- Menu 1 -->
                <div class="menu-item transition-all duration-300 ease-in-out transform scale-100 opacity-100 bg-gray-50 p-6 rounded-xl shadow hover:shadow-lg hover:scale-105 will-change-transform" data-category="cemilan">
                    <img src="/img/dimsum.jpg" alt="Dimsum" class="rounded-lg mb-4 w-full h-58 object-cover transition duration-300">
                ...
                <div class="menu-item transition-all duration-300 ease-in-out transform scale-100 opacity-100 bg-gray-50 p-6 rounded-xl shadow hover:shadow-lg hover:scale-105" data-category="makanan">
                    <img src="/img/salad.jpg" alt="Salad Buah" class="rounded-lg mb-4 w-full h-58 object-cover">
                ...
                <!-- Menu 3 -->
                <div class="menu-item transition-all duration-300 ease-in-out transform scale-100 opacity-100 bg-gray-50 p-6 rounded-xl shadow hover:shadow-lg hover:scale-105" data-category="makanan">
                    <img src="/img/zupa.jpg" alt="Puyo" class="rounded-lg mb-4 w-full h-58 object-cover">
